    ...
    def create_timer(self, iid : str, token_stack : str, args : list):
        ...
        if context.is_cycle:
            if not self.is_start_event:
                ...
                # of recurrences seen.
                context.token_pool_id = TokenPool.create(iid, context.recurrance).get_name()
...
if __name__ == "__main__":
    ...
    restored_json = '{"guid": "15338b7c88e642bbab48793a42bad81f", "iid":"test_did-test_did_iid", "timer_type": "TIME_DURATION", "start_date": 1625846154, "end_date": null, "interval": 300, "recurrance": 0, "spec": "PT5M", "token_stack": "", "exec_time": 1625846454, "token_pool_id": null, "args": ["{}", 1, "hello", "application/json"], "completed": false}'
